...
#pragma acc routine(Forest::forestIsBurning)
#pragma acc routine(Forest::print)
#pragma acc routine(Forest::getPercentBurned)
#pragma acc routine(Forest::reset)
#pragma acc routine(Forest::treeBurns)
